...
public class Paddle : MonoBehaviour
{
    ...
    public AudioClip ExtendOrShrink, LightningBall, MultiBall, ShootingPaddle;
    ...
    {
        if (coll.gameObject.name == "ExtendOrShrink")
            AudioSource.clip = ExtendOrShrink;
        else
            if (coll.gameObject.name == "LightningBall")
            AudioSource.clip = LightningBall;
        else
            if (coll.gameObject.name == "MultiBall")
            AudioSource.clip = MultiBall;
        else
            if (coll.gameObject.name == "ShootingPaddle")
            AudioSource.clip = ShootingPaddle;
